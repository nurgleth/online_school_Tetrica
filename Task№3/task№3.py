...
def appearance(intervals: dict):
    ...
    lesson_set = set()  # создаем множество для временых промежутков урока
    ...
    for i in range(len(start_all_pupil)):  # генерируем секунды и добавляем их в список
        ...
        for i in tmp:
            pupil.append(i)
    pupil.sort()
    pupil_set = set()  # создаем множество для временых промежутков ученика
    ...
    tutor_set.update(tutor)  # добавляем во множество список элементов
